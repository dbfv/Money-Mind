...
const DayDetailsForm = ({
    ...
    const TransactionItem = ({ transaction }) => {
        ...
        return (
            <div className={`p-3 mb-2 rounded-lg ${bgColor} ${borderColor} border`}>
    ...
    const contentSection = (
        <div className="flex flex-col md:flex-row h-full gap-6">
            ...
            <div className="md:w-1/2 bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                ...
                {/* Transaction Summary */}
                {transactions.length > 0 && <TransactionSummary />}
