    ...
    return (
        <div className="min-h-screen flex flex-col lg:flex-row overflow-hidden relative">
            ...
            <div className="flex-1 lg:w-1/2 flex items-center justify-center p-4 md:p-8 relative z-10" style={{ backgroundColor: 'transparent' }}>
                <motion.div
                    className="bg-white/95 backdrop-blur-sm lg:bg-white rounded-2xl shadow-2xl p-4 md:p-6 w-full max-w-sm max-h-[95vh] md:max-h-[90vh] overflow-y-auto relative z-10 border border-gray-200"
                ...
                >
                    <motion.div className="text-center mb-6 md:mb-8" variants={itemVariants}>
                        ...
                        <p className="text-sm md:text-base text-gray-600">Join us and start your financial journey</p>
                    </motion.div>
